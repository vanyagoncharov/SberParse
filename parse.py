...
def parse_sber(url):
    ...
    price = soup.find("div", class_="pdp-sales-block__price-wrap pdp-sales-block__price-wrap_active").find("meta").get(
        "content")
    bonus_amount = soup.find("div",
                             class_="money-bonus pdp-sales-block__bonus lg money-bonus_loyalty pdp-sales-block__bonus_active").find(
        "span", class_="bonus-amount").text
